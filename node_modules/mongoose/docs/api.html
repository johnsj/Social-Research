...
<<<<<<< HEAD
<p>This is the connection used by default for every model created using <a href="#index_Mongoose-model">mongoose.model</a>.</p><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#connection_Connection">Connection</a>&gt; </span><span></span></li></ul></div><hr class=""></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.0rc0/collection.js" id="collection-js">collection.js</a><div class="item method public"><h3 id="collection_Collection"><a href="#collection_Collection">Collection(<code>name</code>, <code>conn</code>, <code>opts</code>)</a></h3><p>Abstract Collection constructor</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">Collection</span> <span class="params">(name, conn, opts)</span> {</span>
=======
<p>This is the connection used by default for every model created using <a href="#index_Mongoose-model">mongoose.model</a>.</p><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#connection_Connection">Connection</a>&gt; </span><span></span></li></ul></div><hr class=""></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.1/collection.js" id="collection-js">collection.js</a><div class="item method public"><h3 id="collection_Collection"><a href="#collection_Collection">Collection(<code>name</code>, <code>conn</code>, <code>opts</code>)</a></h3><p>Abstract Collection constructor</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">Collection</span> <span class="params">(name, conn, opts)</span> {</span>
>>>>>>> temp
...
<<<<<<< HEAD
};</code></pre></div><div class="description"></div><hr class=""></div><div class="item property public"><h3 id="collection_Collection-conn"><a href="#collection_Collection-conn">Collection#<span>conn</span></a></h3><p>The Connection instance</p><hr class=""></div><div class="item property public"><h3 id="collection_Collection-name"><a href="#collection_Collection-name">Collection#<span>name</span></a></h3><p>The collection name</p><hr class=""></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.0rc0/connection.js" id="connection-js">connection.js</a><div class="item method public"><h3 id="connection_Connection"><a href="#connection_Connection">Connection(<code>base</code>)</a></h3><p>Connection constructor</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">Connection</span> <span class="params">(base)</span> {</span>
=======
};</code></pre></div><div class="description"></div><hr class=""></div><div class="item property public"><h3 id="collection_Collection-conn"><a href="#collection_Collection-conn">Collection#<span>conn</span></a></h3><p>The Connection instance</p><hr class=""></div><div class="item property public"><h3 id="collection_Collection-name"><a href="#collection_Collection-name">Collection#<span>name</span></a></h3><p>The collection name</p><hr class=""></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.1/connection.js" id="connection-js">connection.js</a><div class="item method public"><h3 id="connection_Connection"><a href="#connection_Connection">Connection(<code>base</code>)</a></h3><p>Connection constructor</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">Connection</span> <span class="params">(base)</span> {</span>
>>>>>>> temp
...
<<<<<<< HEAD
}</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>callback</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="description"></div><hr class="private"></div><div class="item method private"><h3 id="connection_Connection-onOpen"><a href="#connection_Connection-onOpen">Connection#onOpen()</a></h3><p>Called when the connection is opened</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">Connection.prototype.onOpen = <span class="function"><span class="keyword">function</span> <span class="params">()</span> {</span>
=======
...
>>>>>>> temp
  ...
  <span class="keyword">return</span> <span class="keyword">this</span>;
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>[callback]</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span>optional</span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#connection_Connection">Connection</a>&gt; </span><span>self</span></li></ul></div><div class="description"></div><hr class=""></div><div class="item method private"><h3 id="connection_Connection-onClose"><a href="#connection_Connection-onClose">Connection#onClose()</a></h3><p>Called when the connection closes</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">Connection.prototype.onClose = <span class="function"><span class="keyword">function</span> <span class="params">()</span> {</span>
=======
...
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>level</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Number">Number</a>, <a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span>either off (0), slow (1), or all (2)</span></li><li><code>[ms]</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Number">Number</a>&gt; </span><span>the threshold in milliseconds above which queries will be logged when in `slow` mode. defaults to 100.</span></li><li><code>callback</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="description"></div><hr class=""></div><div class="item method private"><h3 id="connection_Connection-defaultOptions"><a href="#connection_Connection-defaultOptions">Connection#defaultOptions(<code>options</code>)</a></h3><p>Prepares default connection options.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">Connection.prototype.defaultOptions = <span class="function"><span class="keyword">function</span> <span class="params">(options)</span> {</span>
=======
...
<<<<<<< HEAD
conn.on(<span class="string">'disconnected'</span>, callback);</code></pre><hr class=""></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.0rc0/document.js" id="document-js">document.js</a><div class="item method private"><h3 id="document_Document"><a href="#document_Document">Document(<code>obj</code>, <code>[fields]</code>, <code>[skipId]</code>)</a></h3><p>Document constructor.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">Document</span> <span class="params">(obj, fields, skipId)</span> {</span>
=======
conn.on(<span class="string">'disconnected'</span>, callback);</code></pre><hr class=""></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.1/document.js" id="document-js">document.js</a><div class="item method private"><h3 id="document_Document"><a href="#document_Document">Document(<code>obj</code>, <code>[fields]</code>, <code>[skipId]</code>)</a></h3><p>Document constructor.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">Document</span> <span class="params">(obj, fields, skipId)</span> {</span>
>>>>>>> temp
  ...
  <span class="keyword">return</span> <span class="keyword">this</span>;
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>doc</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span>document returned by mongo</span></li><li><code>fn</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span>callback</span></li></ul></div><div class="description"><p>Called internally after a document is returned from mongodb.</p></div><hr class="private"></div><div class="item method private"><h3 id="document_Document-_storeShard"><a href="#document_Document-_storeShard">Document#_storeShard()</a></h3><p>Stores the current values of the shard keys.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">Document.prototype._storeShard = <span class="function"><span class="keyword">function</span> <span class="title">_storeShard</span> <span class="params">()</span> {</span>
=======
...
<<<<<<< HEAD
}</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>doc</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span></span></li><li><code>options</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span></span></li><li><code>callback</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#query-js">Query</a>&gt; </span><span></span></li></ul></div><div class="description"><h4>Example:</h4>
=======
...
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>fn</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span>function to execute</span></li><li><code>scope</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span>the scope with which to call fn</span></li></ul></div><div class="description"></div><hr class="private"></div><div class="item method public"><h3 id="document_Document-modifiedPaths"><a href="#document_Document-modifiedPaths">Document#modifiedPaths()</a></h3><p>Returns the list of paths that have been modified.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">Document.prototype.modifiedPaths = <span class="function"><span class="keyword">function</span> <span class="params">()</span> {</span>
=======
...
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>cb</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span>called after validation completes, passing an error if one occurred</span></li></ul></div><div class="description"><h4>Note:</h4>
=======
...
<pre><code>doc.toObject({ getters: <span class="literal">true</span> })</code></pre></div><hr class=""></div><div class="item method public"><h3 id="document_Document-toJSON"><a href="#document_Document-toJSON">Document#toJSON(<code>options</code>)</a></h3><p>The return value of this method is used in calls to JSON.stringify(doc).</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">Document.prototype.toJSON = <span class="function"><span class="keyword">function</span> <span class="params">(options)</span> {</span>
  ...
  <span class="keyword">return</span> tid.equals
    ...
    : tid === docid;
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>doc</code><span class="types"> &lt;<a href="#document_Document">Document</a>&gt; </span><span>a document to compare</span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Boolean">Boolean</a>&gt; </span><span></span></li></ul></div><div class="description"><p>Documents are considered equal when they have matching <code>_id</code>s.</p></div><hr class=""></div><div class="item property public"><h3 id="document_Document-errors"><a href="#document_Document-errors">Document#<span>errors</span></a></h3><p>Hash containing current validation errors.</p><hr class=""></div><div class="item property public"><h3 id="document_Document-isNew"><a href="#document_Document-isNew">Document#<span>isNew</span></a></h3><p>Boolean flag specifying if the document is new.</p><hr class=""></div><div class="item property public"><h3 id="document_Document-schema"><a href="#document_Document-schema">Document#<span>schema</span></a></h3><p>The documents schema.</p><hr class=""></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.0rc0/drivers/node-mongodb-native/collection.js" id="drivers-node-mongodb-native-collection-js">drivers/node-mongodb-native/collection.js</a><div class="item method private"><h3 id="drivers_node-mongodb-native_collection_NativeCollection"><a href="#drivers_node-mongodb-native_collection_NativeCollection">NativeCollection()</a></h3><p>A <a href="https://github.com/mongodb/node-mongodb-native">node-mongodb-native</a> collection implementation.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">NativeCollection</span> <span class="params">()</span> {</span>
=======
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>doc</code><span class="types"> &lt;<a href="#document_Document">Document</a>&gt; </span><span>a document to compare</span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Boolean">Boolean</a>&gt; </span><span></span></li></ul></div><div class="description"><p>Documents are considered equal when they have matching <code>_id</code>s.</p></div><hr class=""></div><div class="item property public"><h3 id="document_Document-errors"><a href="#document_Document-errors">Document#<span>errors</span></a></h3><p>Hash containing current validation errors.</p><hr class=""></div><div class="item property public"><h3 id="document_Document-isNew"><a href="#document_Document-isNew">Document#<span>isNew</span></a></h3><p>Boolean flag specifying if the document is new.</p><hr class=""></div><div class="item property public"><h3 id="document_Document-schema"><a href="#document_Document-schema">Document#<span>schema</span></a></h3><p>The documents schema.</p><hr class=""></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.1/drivers/node-mongodb-native/collection.js" id="drivers-node-mongodb-native-collection-js">drivers/node-mongodb-native/collection.js</a><div class="item method private"><h3 id="drivers_node-mongodb-native_collection_NativeCollection"><a href="#drivers_node-mongodb-native_collection_NativeCollection">NativeCollection()</a></h3><p>A <a href="https://github.com/mongodb/node-mongodb-native">node-mongodb-native</a> collection implementation.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">NativeCollection</span> <span class="params">()</span> {</span>
>>>>>>> temp
...
<<<<<<< HEAD
};</code></pre></div><div class="description"></div><hr class="private"></div><div class="item method public"><h3 id="drivers_node-mongodb-native_collection_NativeCollection-getIndexes"><a href="#drivers_node-mongodb-native_collection_NativeCollection-getIndexes">NativeCollection#getIndexes(<code>callback</code>)</a></h3><p>Retreives information about this collections indexes.</p><div class="params"><h4>Parameters:</h4><ul><li><code>callback</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="description"></div><hr class=""></div></li><li class="module private"><a href="https://github.com/LearnBoost/mongoose/tree/3.0.0rc0/drivers/node-mongodb-native/connection.js" id="drivers-node-mongodb-native-connection-js">drivers/node-mongodb-native/connection.js</a><div class="item method private"><h3 id="drivers_node-mongodb-native_connection_NativeConnection"><a href="#drivers_node-mongodb-native_connection_NativeConnection">NativeConnection()</a></h3><p>A <a href="https://github.com/mongodb/node-mongodb-native">node-mongodb-native</a> connection implementation.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">NativeConnection</span><span class="params">()</span> {</span>
=======
};</code></pre></div><div class="description"></div><hr class="private"></div><div class="item method public"><h3 id="drivers_node-mongodb-native_collection_NativeCollection-getIndexes"><a href="#drivers_node-mongodb-native_collection_NativeCollection-getIndexes">NativeCollection#getIndexes(<code>callback</code>)</a></h3><p>Retreives information about this collections indexes.</p><div class="params"><h4>Parameters:</h4><ul><li><code>callback</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Function">Function</a>&gt; </span><span></span></li></ul></div><div class="description"></div><hr class=""></div></li><li class="module private"><a href="https://github.com/LearnBoost/mongoose/tree/3.0.1/drivers/node-mongodb-native/connection.js" id="drivers-node-mongodb-native-connection-js">drivers/node-mongodb-native/connection.js</a><div class="item method private"><h3 id="drivers_node-mongodb-native_connection_NativeConnection"><a href="#drivers_node-mongodb-native_connection_NativeConnection">NativeConnection()</a></h3><p>A <a href="https://github.com/mongodb/node-mongodb-native">node-mongodb-native</a> connection implementation.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">NativeConnection</span><span class="params">()</span> {</span>
>>>>>>> temp
...
<span class="function"><span class="keyword">function</span> <span class="title">listen</span> <span class="params">(conn)</span> {</span>
  ...
  conn.db.on(<span class="string">'close'</span>, <span class="keyword">function</span>(){
    ...
    <span class="keyword">if</span> (conn.options.server.auto_reconnect) {
  ...
  conn.db.on(<span class="string">'open'</span>, <span class="function"><span class="keyword">function</span> <span class="params">()</span> {</span>
    conn.emit(<span class="string">'reconnected'</span>)
  })
  conn.db.on(<span class="string">'fullsetup'</span>, <span class="function"><span class="keyword">function</span> <span class="params">()</span> {</span>
    conn.emit(<span class="string">'fullsetup'</span>)
  })
<<<<<<< HEAD
}</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>fn</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#connection_Connection">Connection</a>&gt; </span><span>this</span></li></ul></div><div class="description"></div><hr class="private"></div><div class="item method private"><h3 id="drivers_node-mongodb-native_connection_NativeConnection-doOpenSet"><a href="#drivers_node-mongodb-native_connection_NativeConnection-doOpenSet">NativeConnection#doOpenSet(<code>fn</code>)</a></h3><p>Opens a connection to a MongoDB ReplicaSet.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">NativeConnection.prototype.doOpenSet = <span class="function"><span class="keyword">function</span> <span class="params">(fn)</span> {</span>
=======
...
>>>>>>> temp
  <span class="keyword">if</span> (!<span class="keyword">this</span>.db) {
    ...
    <span class="keyword">this</span>.db = <span class="keyword">new</span> mongo.Db(<span class="keyword">this</span>.name, server, <span class="keyword">this</span>.options.db);
    listen(<span class="keyword">this</span>);
  }
  ...
  <span class="keyword">return</span> <span class="keyword">this</span>;
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>fn</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#connection_Connection">Connection</a>&gt; </span><span>this</span></li></ul></div><div class="description"><p>See description of <a href="#NativeConnection-doOpen">doOpen</a> for server options. In this case <code>options.replset</code> is also passed to ReplSetServers.</p></div><hr class="private"></div><div class="item method private"><h3 id="drivers_node-mongodb-native_connection_NativeConnection-doClose"><a href="#drivers_node-mongodb-native_connection_NativeConnection-doClose">NativeConnection#doClose(<code>fn</code>)</a></h3><p>Closes the connection</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">NativeConnection.prototype.doClose = <span class="function"><span class="keyword">function</span> <span class="params">(fn)</span> {</span>
  <span class="keyword">this</span>.db.close();
  <span class="keyword">if</span> (fn) fn();
  <span class="keyword">return</span> <span class="keyword">this</span>;
}</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>fn</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#connection_Connection">Connection</a>&gt; </span><span>this</span></li></ul></div><div class="description"></div><hr class="private"></div></li><li class="module private"><a href="https://github.com/LearnBoost/mongoose/tree/3.0.0rc0/error.js" id="error-js">error.js</a><div class="item method private"><h3 id="error_MongooseError"><a href="#error_MongooseError">MongooseError()</a></h3><p>Mongoose error</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">MongooseError</span> <span class="params">(msg)</span> {</span>
=======
  ...
  <span class="keyword">if</span> (fn) fn();
  <span class="keyword">return</span> <span class="keyword">this</span>;
}</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>fn</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Function">Function</a>&gt; </span><span></span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#connection_Connection">Connection</a>&gt; </span><span>this</span></li></ul></div><div class="description"></div><hr class="private"></div></li><li class="module private"><a href="https://github.com/LearnBoost/mongoose/tree/3.0.1/error.js" id="error-js">error.js</a><div class="item method private"><h3 id="error_MongooseError"><a href="#error_MongooseError">MongooseError()</a></h3><p>Mongoose error</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">MongooseError</span> <span class="params">(msg)</span> {</span>
>>>>>>> temp
...
<<<<<<< HEAD
};</code></pre></div><div class="inherits"><h4>Inherits:</h4><ul><li><a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Error" title="Error">Error</a></li></ul></div><div class="description"></div><hr class="private"></div></li><li class="module private"><a href="https://github.com/LearnBoost/mongoose/tree/3.0.0rc0/errors/cast.js" id="errors-cast-js">errors/cast.js</a><div class="item method private"><h3 id="errors_cast_CastError"><a href="#errors_cast_CastError">CastError(<code>type</code>, <code>value</code>)</a></h3><p>Casting Error constructor.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">CastError</span> <span class="params">(type, value)</span> {</span>
=======
};</code></pre></div><div class="inherits"><h4>Inherits:</h4><ul><li><a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Error" title="Error">Error</a></li></ul></div><div class="description"></div><hr class="private"></div></li><li class="module private"><a href="https://github.com/LearnBoost/mongoose/tree/3.0.1/errors/cast.js" id="errors-cast-js">errors/cast.js</a><div class="item method private"><h3 id="errors_cast_CastError"><a href="#errors_cast_CastError">CastError(<code>type</code>, <code>value</code>)</a></h3><p>Casting Error constructor.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">CastError</span> <span class="params">(type, value)</span> {</span>
>>>>>>> temp
...
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>type</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span></span></li><li><code>value</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span></span></li></ul></div><div class="inherits"><h4>Inherits:</h4><ul><li><a href="#error_MongooseError">MongooseError</a></li></ul></div><div class="description"></div><hr class="private"></div></li><li class="module private"><a href="https://github.com/LearnBoost/mongoose/tree/3.0.0rc0/errors/document.js" id="errors-document-js">errors/document.js</a><div class="item method private"><h3 id="errors_document_DocumentError"><a href="#errors_document_DocumentError">DocumentError(<code>msg</code>)</a></h3><p>Document Error</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">DocumentError</span> <span class="params">(msg)</span> {</span>
...
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>msg</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span></span></li></ul></div><div class="inherits"><h4>Inherits:</h4><ul><li><a href="#error_MongooseError">MongooseError</a></li></ul></div><div class="description"></div><hr class="private"></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.0rc0/errors/validation.js" id="errors-validation-js">errors/validation.js</a><div class="item method private"><h3 id="errors_validation_ValidationError"><a href="#errors_validation_ValidationError">ValidationError(<code>instance</code>)</a></h3><p>Document Validation Error</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">ValidationError</span> <span class="params">(instance)</span> {</span>
=======
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>type</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span></span></li><li><code>value</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span></span></li></ul></div><div class="inherits"><h4>Inherits:</h4><ul><li><a href="#error_MongooseError">MongooseError</a></li></ul></div><div class="description"></div><hr class="private"></div></li><li class="module private"><a href="https://github.com/LearnBoost/mongoose/tree/3.0.1/errors/document.js" id="errors-document-js">errors/document.js</a><div class="item method private"><h3 id="errors_document_DocumentError"><a href="#errors_document_DocumentError">DocumentError(<code>msg</code>)</a></h3><p>Document Error</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">DocumentError</span> <span class="params">(msg)</span> {</span>
  MongooseError.call(<span class="keyword">this</span>, msg);
  Error.captureStackTrace(<span class="keyword">this</span>, arguments.callee);
  <span class="keyword">this</span>.name = <span class="string">'DocumentError'</span>;
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>msg</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span></span></li></ul></div><div class="inherits"><h4>Inherits:</h4><ul><li><a href="#error_MongooseError">MongooseError</a></li></ul></div><div class="description"></div><hr class="private"></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.1/errors/validation.js" id="errors-validation-js">errors/validation.js</a><div class="item method private"><h3 id="errors_validation_ValidationError"><a href="#errors_validation_ValidationError">ValidationError(<code>instance</code>)</a></h3><p>Document Validation Error</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">ValidationError</span> <span class="params">(instance)</span> {</span>
>>>>>>> temp
...
<<<<<<< HEAD
};</code></pre></div><div class="description"></div><hr class=""></div></li><li class="module private"><a href="https://github.com/LearnBoost/mongoose/tree/3.0.0rc0/errors/validator.js" id="errors-validator-js">errors/validator.js</a><div class="item method private"><h3 id="errors_validator_ValidatorError"><a href="#errors_validator_ValidatorError">ValidatorError(<code>path</code>, <code>msg</code>)</a></h3><p>Schema validator error</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">ValidatorError</span> <span class="params">(path, type)</span> {</span>
=======
};</code></pre></div><div class="description"></div><hr class=""></div></li><li class="module private"><a href="https://github.com/LearnBoost/mongoose/tree/3.0.1/errors/validator.js" id="errors-validator-js">errors/validator.js</a><div class="item method private"><h3 id="errors_validator_ValidatorError"><a href="#errors_validator_ValidatorError">ValidatorError(<code>path</code>, <code>msg</code>)</a></h3><p>Schema validator error</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">ValidatorError</span> <span class="params">(path, type)</span> {</span>
>>>>>>> temp
  ...
  <span class="keyword">this</span>.type = type;
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>path</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span></span></li><li><code>msg</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span></span></li></ul></div><div class="inherits"><h4>Inherits:</h4><ul><li><a href="#error_MongooseError">MongooseError</a></li></ul></div><div class="description"></div><hr class="private"></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.0rc0/model.js" id="model-js">model.js</a><div class="item method public"><h3 id="model_Model"><a href="#model_Model">Model(<code>doc</code>)</a></h3><p>Model constructor</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">Model</span> <span class="params">(doc, fields, skipId)</span> {</span>
=======
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>path</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span></span></li><li><code>msg</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span></span></li></ul></div><div class="inherits"><h4>Inherits:</h4><ul><li><a href="#error_MongooseError">MongooseError</a></li></ul></div><div class="description"></div><hr class="private"></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.1/model.js" id="model-js">model.js</a><div class="item method public"><h3 id="model_Model"><a href="#model_Model">Model(<code>doc</code>)</a></h3><p>Model constructor</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">Model</span> <span class="params">(doc, fields, skipId)</span> {</span>
>>>>>>> temp
...
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>doc</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span>document returned by mongo</span></li><li><code>query</code><span class="types"> &lt;<a href="#query-js">Query</a>&gt; </span><span>query that originated the initialization</span></li><li><code>fn</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="description"></div><hr class="private"></div><div class="item method public"><h3 id="model_Model-save"><a href="#model_Model-save">Model#save(<code>[fn]</code>)</a></h3><p>Saves this document.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">Model.prototype.save = <span class="function"><span class="keyword">function</span> <span class="title">save</span> <span class="params">(fn)</span> {</span>
=======
...
<pre><code>Product.on(<span class="string">'error'</span>, handleError);</code></pre></div><hr class=""></div><div class="item method private"><h3 id="model_Model-_delta"><a href="#model_Model-_delta">Model#_delta()</a></h3><p>Produces a special query document of the modified properties used in updates.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">Model.prototype._delta = <span class="function"><span class="keyword">function</span> <span class="title">_delta</span> <span class="params">()</span> {</span>
  ...
  <span class="keyword">return</span> <span class="keyword">this</span>;
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>[fn]</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span>optional callback</span></li></ul></div><div class="description"><h4>Example:</h4>
=======
...
<<<<<<< HEAD
doc.model(<span class="string">'User'</span>).findById(id, callback);</code></pre></div><hr class=""></div><div class="item method public"><h3 id="model_Model-%24where"><a href="#model_Model-%24where">Model#$where(<code>argument</code>)</a></h3><p>Creates a <code>Query</code> and specifies a <code>$where</code> condition.</p><div class="params"><h4>Parameters:</h4><ul><li><code>argument</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>, <a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span>is a javascript string or anonymous function</span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#query-js">Query</a>&gt; </span><span></span></li></ul></div><div class="see"><h4>See:</h4><ul class="see"><li><a href="#query_Query-%24where" title="Query.$where">Query.$where</a></li></ul></div><div class="description"><p>Sometimes you need to query for things in mongodb using a JavaScript expression. You can do so via <code>find({ $where: javascript })</code>, or you can use the mongoose shortcut method $where via a Query chain or from your mongoose Model.</p>
=======
...
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>conditions</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span></span></li><li><code>[callback]</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#query-js">Query</a>&gt; </span><span></span></li></ul></div><hr class=""></div><div class="item static public"><h3 id="model_Model-find"><a href="#model_Model-find">Model.find(<code>conditions</code>, <code>[fields]</code>, <code>[options]</code>, <code>[callback]</code>)</a></h3><p>Finds documents</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">Model.find = <span class="function"><span class="keyword">function</span> <span class="title">find</span> <span class="params">(conditions, fields, options, callback)</span> {</span>
=======
...
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>conditions</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span></span></li><li><code>[fields]</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span>optional fields to select</span></li><li><code>[options]</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span>optional</span></li><li><code>[callback]</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#query-js">Query</a>&gt; </span><span></span></li></ul></div><h4>Examples:</h4>
=======
...
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>id</code><span class="types"> &lt;<a href="#types_objectid_ObjectId">ObjectId</a>, <a href="#HexId">HexId</a>&gt; </span><span>objectid, or a value that can be casted to one</span></li><li><code>[fields]</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span>optional fields to select</span></li><li><code>[options]</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span>optional</span></li><li><code>[callback]</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#query-js">Query</a>&gt; </span><span></span></li></ul></div><p>The <code>id</code> is cast to an ObjectId before sending the command.</p>
=======
...
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>conditions</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span></span></li><li><code>[fields]</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span>optional fields to select</span></li><li><code>[options]</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span>optional</span></li><li><code>[callback]</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#query-js">Query</a>&gt; </span><span></span></li></ul></div><p>The <code>conditions</code> are cast to their respective SchemaTypes before the command is sent.</p>
=======
...
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>conditions</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span></span></li><li><code>[callback]</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#query-js">Query</a>&gt; </span><span></span></li></ul></div><h4>Example:</h4>
=======
...
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>field</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span></span></li><li><code>[conditions]</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span>optional</span></li><li><code>[callback]</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#query-js">Query</a>&gt; </span><span></span></li></ul></div><hr class=""></div><div class="item static public"><h3 id="model_Model-where"><a href="#model_Model-where">Model.where(<code>path</code>, <code>[val]</code>)</a></h3><p>Creates a Query, applies the passed conditions, and returns the Query.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">Model.where = <span class="function"><span class="keyword">function</span> <span class="title">where</span> <span class="params">(path, val)</span> {</span>
=======
...
<<<<<<< HEAD
}</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>id</code><span class="types"> &lt;<a href="#types_objectid_ObjectId">ObjectId</a>, <a href="#HexId">HexId</a>&gt; </span><span>an ObjectId or string that can be cast to one.</span></li><li><code>[update]</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span></span></li><li><code>[options]</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span></span></li><li><code>[callback]</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#query-js">Query</a>&gt; </span><span></span></li></ul></div><div class="see"><h4>See:</h4><ul class="see"><li><a href="#model_Model-findOneAndUpdate" title="Model.findOneAndUpdate">Model.findOneAndUpdate</a></li><li><a href="http://www.mongodb.org/display/DOCS/findAndModify+Command" title="mongodb">mongodb</a></li></ul></div><p>Finds a matching document, updates it according to the <code>update</code> arg, passing any <code>options</code>, and returns the found document (if any) to the callback. The query executes immediately if <code>callback</code> is passed else a Query object is returned.</p>
=======
...
<<<<<<< HEAD
}</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>id</code><span class="types"> &lt;<a href="#types_objectid_ObjectId">ObjectId</a>, <a href="#HexString">HexString</a>&gt; </span><span>ObjectId or string that can be cast to one</span></li><li><code>[options]</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span></span></li><li><code>[callback]</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#query-js">Query</a>&gt; </span><span></span></li></ul></div><div class="see"><h4>See:</h4><ul class="see"><li><a href="#model_Model-findOneAndRemove" title="Model.findOneAndRemove">Model.findOneAndRemove</a></li><li><a href="http://www.mongodb.org/display/DOCS/findAndModify+Command" title="mongodb">mongodb</a></li></ul></div><p>Finds a matching document, removes it, passing the found document (if any) to the callback.</p>
=======
...
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>doc</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Array">Array</a>, <a href="#Object...">Object...</a>&gt; </span><span></span></li><li><code>fn</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span>callback</span></li></ul></div><h4>Example:</h4>
=======
...
<<<<<<< HEAD
})</code></pre><hr class=""></div><div class="item property public"><h3 id="model_Model-base"><a href="#model_Model-base">Model#<span>base</span></a></h3><p>Base Mongoose instance the model uses.</p><hr class=""></div><div class="item property public"><h3 id="model_Model-collection"><a href="#model_Model-collection">Model#<span>collection</span></a></h3><p>Collection the model uses.</p><hr class=""></div><div class="item property public"><h3 id="model_Model-db"><a href="#model_Model-db">Model#<span>db</span></a></h3><p>Database instance the model uses.</p><hr class=""></div><div class="item property public"><h3 id="model_Model-schema"><a href="#model_Model-schema">Model#<span>schema</span></a></h3><p>Schema the model uses.</p><hr class=""></div><div class="item property public"><h3 id="model_Model-modelName"><a href="#model_Model-modelName">Model#<span>modelName</span></a></h3><p>The name of the model</p><hr class=""></div><div class="item property public"><h3 id="model_Model-collection"><a href="#model_Model-collection">Model#<span>collection</span></a></h3><p>Collection the model uses.</p><hr class=""></div><div class="item property public"><h3 id="model_Model-db"><a href="#model_Model-db">Model#<span>db</span></a></h3><p>Connection the model uses.</p><hr class=""></div></li><li class="module private"><a href="https://github.com/LearnBoost/mongoose/tree/3.0.0rc0/namedscope.js" id="namedscope-js">namedscope.js</a><div class="item method private"><h3 id="namedscope_NamedScope-decorate"><a href="#namedscope_NamedScope-decorate">NamedScope#decorate(<code>target</code>, <code>getters</code>)</a></h3><p>Decorate</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">NamedScope.prototype.decorate = <span class="function"><span class="keyword">function</span> <span class="params">(target, getters)</span> {</span>
=======
})</code></pre><hr class=""></div><div class="item property public"><h3 id="model_Model-base"><a href="#model_Model-base">Model#<span>base</span></a></h3><p>Base Mongoose instance the model uses.</p><hr class=""></div><div class="item property public"><h3 id="model_Model-collection"><a href="#model_Model-collection">Model#<span>collection</span></a></h3><p>Collection the model uses.</p><hr class=""></div><div class="item property public"><h3 id="model_Model-db"><a href="#model_Model-db">Model#<span>db</span></a></h3><p>Database instance the model uses.</p><hr class=""></div><div class="item property public"><h3 id="model_Model-schema"><a href="#model_Model-schema">Model#<span>schema</span></a></h3><p>Schema the model uses.</p><hr class=""></div><div class="item property public"><h3 id="model_Model-modelName"><a href="#model_Model-modelName">Model#<span>modelName</span></a></h3><p>The name of the model</p><hr class=""></div><div class="item property public"><h3 id="model_Model-collection"><a href="#model_Model-collection">Model#<span>collection</span></a></h3><p>Collection the model uses.</p><hr class=""></div><div class="item property public"><h3 id="model_Model-db"><a href="#model_Model-db">Model#<span>db</span></a></h3><p>Connection the model uses.</p><hr class=""></div></li><li class="module private"><a href="https://github.com/LearnBoost/mongoose/tree/3.0.1/namedscope.js" id="namedscope-js">namedscope.js</a><div class="item method private"><h3 id="namedscope_NamedScope-decorate"><a href="#namedscope_NamedScope-decorate">NamedScope#decorate(<code>target</code>, <code>getters</code>)</a></h3><p>Decorate</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">NamedScope.prototype.decorate = <span class="function"><span class="keyword">function</span> <span class="params">(target, getters)</span> {</span>
>>>>>>> temp
...
<<<<<<< HEAD
module.exports = NamedScope;</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>target</code><span class="types"> &lt;<a href="#NamedScope">NamedScope</a>&gt; </span><span></span></li><li><code>getters</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span></span></li></ul></div><div class="description"></div><hr class="private"></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.0rc0/promise.js" id="promise-js">promise.js</a><div class="item method public"><h3 id="promise_Promise"><a href="#promise_Promise">Promise(<code>back</code>)</a></h3><p>Promise constructor.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">Promise</span> <span class="params">(back)</span> {</span>
...
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>back</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span>a callback+errback that accepts `fn(err, ...){}` as signature</span></li></ul></div><div class="inherits"><h4>Inherits:</h4><ul><li><a href="http://nodejs.org/api/events.html#events_class_events_eventemitter" title="NodeJS EventEmitter">NodeJS EventEmitter</a></li></ul></div><div class="events"><h4>Events:</h4><ul><li><p><code>err</code>: Emits when the promise resolves to an error.</p></li><li><p><code>complete</code>: Emits when the promise resolves sucessfully.</p></li></ul></div><div class="description"></div><hr class=""></div><div class="item method public"><h3 id="promise_Promise-on"><a href="#promise_Promise-on">Promise#on(<code>event</code>, <code>callback</code>)</a></h3><p>Adds <code>listener</code> to the <code>event</code>.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">Promise.prototype.on = <span class="function"><span class="keyword">function</span> <span class="params">(event, callback)</span> {</span>
=======
module.exports = NamedScope;</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>target</code><span class="types"> &lt;<a href="#NamedScope">NamedScope</a>&gt; </span><span></span></li><li><code>getters</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span></span></li></ul></div><div class="description"></div><hr class="private"></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.1/promise.js" id="promise-js">promise.js</a><div class="item method public"><h3 id="promise_Promise"><a href="#promise_Promise">Promise(<code>back</code>)</a></h3><p>Promise constructor.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">Promise</span> <span class="params">(back)</span> {</span>
  <span class="keyword">this</span>.emitted = {};
  <span class="keyword">if</span> (<span class="string">'function'</span> == <span class="keyword">typeof</span> back)
    <span class="keyword">this</span>.addBack(back);
...
>>>>>>> temp
  ...
  <span class="keyword">return</span> <span class="keyword">this</span>;
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>event</code><span class="types"> &lt;<a href="#Event">Event</a>&gt; </span><span></span></li><li><code>callback</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#promise_Promise">Promise</a>&gt; </span><span>this</span></li></ul></div><div class="description"><p>If <code>event</code> is either <code>error</code> or <code>complete</code> and the event has already been emitted, the<code>listener</code> is called immediately and passed the results of the original emitted event.</p></div><hr class=""></div><div class="item method private"><h3 id="promise_Promise-emit"><a href="#promise_Promise-emit">Promise#emit()</a></h3><p>Keeps track of emitted events to run them on <code>on</code>.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">Promise.prototype.emit = <span class="function"><span class="keyword">function</span> <span class="params">(event)</span> {</span>
=======
...
>>>>>>> temp
  ...
  <span class="keyword">return</span> <span class="keyword">this</span>;
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>fn</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#promise_Promise">Promise</a>&gt; </span><span></span></li></ul></div><div class="description"></div><hr class=""></div><div class="item method public"><h3 id="promise_Promise-resolve"><a href="#promise_Promise-resolve">Promise#resolve(<code>err</code>, <code>val</code>)</a></h3><p>Sugar for handling cases where you may be resolving to either an error condition or a success condition.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">Promise.prototype.resolve = <span class="function"><span class="keyword">function</span> <span class="params">(err, val)</span> {</span>
...
=======
  ...
  <span class="keyword">if</span> (err) <span class="keyword">return</span> <span class="keyword">this</span>.error(err);
  <span class="keyword">return</span> <span class="keyword">this</span>.complete(val);
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>err</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Error">Error</a>&gt; </span><span>optional error or null</span></li><li><code>val</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span>value to complete the promise with</span></li></ul></div><div class="description"></div><hr class=""></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.1/query.js" id="query-js">query.js</a><div class="item method public"><h3 id="query_Query"><a href="#query_Query">Query(<code>criteria</code>, <code>options</code>)</a></h3><p>Query constructor used for building queries.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">Query</span> <span class="params">(criteria, options)</span> {</span>
>>>>>>> temp
...
<p><em>* denotes a query helper method is also available</em></p></div><hr class=""></div><div class="item method private"><h3 id="query_Query-bind"><a href="#query_Query-bind">Query#bind(<code>model</code>, <code>op</code>, <code>updateArg</code>)</a></h3><p>Binds this query to a model.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">Query.prototype.bind = <span class="function"><span class="keyword">function</span> <span class="title">bind</span> <span class="params">(model, op, updateArg)</span> {</span>
  ...
  <span class="keyword">return</span> promise;
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>[operation]</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>, <a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li><li><code>[callback]</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#promise_Promise">Promise</a>&gt; </span><span></span></li></ul></div><div class="description"><h4>Examples</h4>
=======
...
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>[criteria]</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span>mongodb selector</span></li><li><code>[callback]</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#query-js">Query</a>&gt; </span><span>this</span></li></ul></div><div class="description"><p>When no <code>callback</code> is passed, the query is not executed.</p>
=======
...
<<<<<<< HEAD
}</code></pre></div><div class="description"></div><hr class="private"></div><div class="item method public"><h3 id="query_Query-%24where"><a href="#query_Query-%24where">Query#$where(<code>js</code>)</a></h3><p>Specifies a <code>$where</code> condition</p><div class="params"><h4>Parameters:</h4><ul><li><code>js</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>, <a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span>javascript string or function</span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#query-js">Query</a>&gt; </span><span>this</span></li></ul></div><div class="description"><p>Use <code>$where</code> when you need to select documents using a JavaScript expression.</p>
=======
...
<span class="keyword">new</span> Query().slaveOk(<span class="literal">false</span>)</code></pre></div><hr class=""></div><div class="item method public"><h3 id="query_Query-tailable"><a href="#query_Query-tailable">Query#tailable(<code>v</code>)</a></h3><p>Sets tailable option.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">Query.prototype.tailable = <span class="function"><span class="keyword">function</span> <span class="params">(v)</span> {</span>
=======
}</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>v</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Boolean">Boolean</a>&gt; </span><span>defaults to true</span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#query-js">Query</a>&gt; </span><span>this</span></li></ul></div><div class="see"><h4>See:</h4><ul class="see"><li><a href="http://docs.mongodb.org/manual/applications/replication/#read-preference" title="mongodb">mongodb</a></li></ul></div><div class="description"><h4>Example:</h4>
...
Kitten.find().tailable(<span class="literal">false</span>)</code></pre></div><hr class=""></div><div class="item method private"><h3 id="query_Query-execFind"><a href="#query_Query-execFind">Query#execFind(<code>callback</code>)</a></h3><p>Executes the query as a find() operation.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">Query.prototype.execFind = <span class="function"><span class="keyword">function</span> <span class="params">(callback)</span> {</span>
  ...
  <span class="keyword">return</span> <span class="keyword">this</span>;
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>callback</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#query-js">Query</a>&gt; </span><span>this</span></li></ul></div><div class="description"></div><hr class="private"></div><div class="item method public"><h3 id="query_Query-findOne"><a href="#query_Query-findOne">Query#findOne(<code>callback</code>)</a></h3><p>Executes the query as a findOne() operation.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">Query.prototype.findOne = <span class="function"><span class="keyword">function</span> <span class="params">(callback)</span> {</span>
=======
...
>>>>>>> temp
  ...
  <span class="keyword">return</span> <span class="keyword">this</span>;
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>callback</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#query-js">Query</a>&gt; </span><span>this</span></li></ul></div><div class="description"><h4>Example</h4>
=======
...
<pre><code>Kitten.where(<span class="string">'color'</span>, <span class="string">'white'</span>).findOne(<span class="function"><span class="keyword">function</span> <span class="params">(err, kitten)</span> {</span>
  ...
  <span class="keyword">return</span> <span class="keyword">this</span>;
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>callback</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#query-js">Query</a>&gt; </span><span>this</span></li></ul></div><div class="see"><h4>See:</h4><ul class="see"><li><a href="http://www.mongodb.org/display/DOCS/Aggregation#Aggregation-Count" title="mongodb">mongodb</a></li></ul></div><div class="description"><h4>Example</h4>
=======
...
<pre><code>Kitten.where(<span class="string">'color'</span>, <span class="string">'black'</span>).count(<span class="function"><span class="keyword">function</span> <span class="params">(err, count)</span> {</span>
  ...
  <span class="keyword">return</span> <span class="keyword">this</span>;
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>field</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span></span></li><li><code>callback</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#query-js">Query</a>&gt; </span><span>this</span></li></ul></div><div class="see"><h4>See:</h4><ul class="see"><li><a href="http://www.mongodb.org/display/DOCS/Aggregation#Aggregation-Distinct" title="mongodb">mongodb</a></li></ul></div><div class="description"></div><hr class=""></div><div class="item method public"><h3 id="query_Query-update"><a href="#query_Query-update">Query#update(<code>doc</code>, <code>callback</code>)</a></h3><p>Executes this query as an update() operation.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">Query.prototype.update = <span class="function"><span class="keyword">function</span> <span class="title">update</span> <span class="params">(doc, callback)</span> {</span>
=======
...
>>>>>>> temp
  ...
  <span class="keyword">return</span> <span class="keyword">this</span>;
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>doc</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span>the update conditions</span></li><li><code>callback</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#query-js">Query</a>&gt; </span><span>this</span></li></ul></div><div class="description"><p><em>All paths passed that are not $atomic operations will become $set ops so we retain backwards compatibility.</em></p>
=======
...
<p>Passing an empty object <code>{}</code> as the doc will result in a no-op. The update operation will be ignored and the callback executed without sending the command to MongoDB so as to prevent accidently overwritting the collection.</p></div><hr class=""></div><div class="item method private"><h3 id="query_Query-_castUpdate"><a href="#query_Query-_castUpdate">Query#_castUpdate(<code>obj</code>)</a></h3><p>Casts obj for an update command.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">Query.prototype._castUpdate = <span class="function"><span class="keyword">function</span> <span class="title">_castUpdate</span> <span class="params">(obj)</span> {</span>
  ...
  <span class="keyword">return</span> <span class="keyword">this</span>;
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>callback</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="description"><h4>Example</h4>
=======
...
<<<<<<< HEAD
}</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>[query]</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span></span></li><li><code>[doc]</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span></span></li><li><code>[options]</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span></span></li><li><code>[callback]</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#query-js">Query</a>&gt; </span><span>this</span></li></ul></div><div class="see"><h4>See:</h4><ul class="see"><li><a href="http://www.mongodb.org/display/DOCS/findAndModify+Command" title="mongodb">mongodb</a></li></ul></div><div class="description"><p>Finds a matching document, updates it according to the <code>update</code> arg, passing any <code>options</code>, and returns the found document (if any) to the callback. The query executes immediately if <code>callback</code> is passed else a Query object is returned.</p>
=======
...
A.where().findOneAndRemove()           <span class="comment">// returns Query</span></code></pre></div><hr class=""></div><div class="item method private"><h3 id="query_Query-_findAndModify"><a href="#query_Query-_findAndModify">Query#_findAndModify(<code>type</code>, <code>callback</code>)</a></h3><p>_findAndModify</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">Query.prototype._findAndModify = <span class="function"><span class="keyword">function</span> <span class="params">(type, callback)</span> {</span>
  ...
  <span class="keyword">return</span> promise;
<<<<<<< HEAD
}</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>type</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span>- either &quot;remove&quot; or &quot;update&quot;</span></li><li><code>callback</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="description"></div><hr class="private"></div><div class="item method public"><h3 id="query_Query-populate"><a href="#query_Query-populate">Query#populate(<code>path</code>, <code>[fields]</code>, <code>[model]</code>, <code>[conditions]</code>, <code>[options]</code>)</a></h3><p>Specifies paths which should be populated.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">Query.prototype.populate = <span class="function"><span class="keyword">function</span> <span class="params">(path, fields, model, conditions, options)</span> {</span>
=======
...
<<<<<<< HEAD
query.within.center()</code></pre><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#query-js">Query</a>&gt; </span><span>this</span></li></ul></div><hr class=""></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.0rc0/querystream.js" id="querystream-js">querystream.js</a><div class="item method public"><h3 id="querystream_QueryStream"><a href="#querystream_QueryStream">QueryStream(<code>query</code>)</a></h3><p>Provides a <a href="http://nodejs.org/api/stream.html#stream_readable_stream">ReadStream</a> interface for Queries.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">QueryStream</span> <span class="params">(query)</span> {</span>
=======
query.within.center()</code></pre><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#query-js">Query</a>&gt; </span><span>this</span></li></ul></div><hr class=""></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.1/querystream.js" id="querystream-js">querystream.js</a><div class="item method public"><h3 id="querystream_QueryStream"><a href="#querystream_QueryStream">QueryStream(<code>query</code>)</a></h3><p>Provides a <a href="http://nodejs.org/api/stream.html#stream_readable_stream">ReadStream</a> interface for Queries.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">QueryStream</span> <span class="params">(query)</span> {</span>
>>>>>>> temp
...
>>>>>>> temp
  ...
  <span class="keyword">return</span> val &amp;&amp; isMongooseObject(val)
    ...
    : val;
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>$conditional</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span></span></li><li><code>[value]</code><span class="types"> &lt;<a href="#any">any</a>&gt; </span><span></span></li></ul></div><div class="description"></div><hr class="private"></div></li><li class="module private"><a href="https://github.com/LearnBoost/mongoose/tree/3.0.0rc0/schema/boolean.js" id="schema-boolean-js">schema/boolean.js</a><div class="item method private"><h3 id="schema_boolean_SchemaBoolean"><a href="#schema_boolean_SchemaBoolean">SchemaBoolean(<code>path</code>, <code>options</code>)</a></h3><p>Boolean SchemaType constructor.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">SchemaBoolean</span> <span class="params">(path, options)</span> {</span>
=======
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>$conditional</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span></span></li><li><code>[value]</code><span class="types"> &lt;<a href="#any">any</a>&gt; </span><span></span></li></ul></div><div class="description"></div><hr class="private"></div></li><li class="module private"><a href="https://github.com/LearnBoost/mongoose/tree/3.0.1/schema/boolean.js" id="schema-boolean-js">schema/boolean.js</a><div class="item method private"><h3 id="schema_boolean_SchemaBoolean"><a href="#schema_boolean_SchemaBoolean">SchemaBoolean(<code>path</code>, <code>options</code>)</a></h3><p>Boolean SchemaType constructor.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">SchemaBoolean</span> <span class="params">(path, options)</span> {</span>
>>>>>>> temp
...
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>$conditional</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span></span></li><li><code>val</code><span class="types"> &lt;<a href="#any">any</a>&gt; </span><span></span></li></ul></div><div class="description"></div><hr class="private"></div></li><li class="module private"><a href="https://github.com/LearnBoost/mongoose/tree/3.0.0rc0/schema/buffer.js" id="schema-buffer-js">schema/buffer.js</a><div class="item method private"><h3 id="schema_buffer_SchemaBuffer"><a href="#schema_buffer_SchemaBuffer">SchemaBuffer(<code>key</code>, <code>cast</code>)</a></h3><p>Buffer SchemaType constructor</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">SchemaBuffer</span> <span class="params">(key, options)</span> {</span>
=======
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>$conditional</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span></span></li><li><code>val</code><span class="types"> &lt;<a href="#any">any</a>&gt; </span><span></span></li></ul></div><div class="description"></div><hr class="private"></div></li><li class="module private"><a href="https://github.com/LearnBoost/mongoose/tree/3.0.1/schema/buffer.js" id="schema-buffer-js">schema/buffer.js</a><div class="item method private"><h3 id="schema_buffer_SchemaBuffer"><a href="#schema_buffer_SchemaBuffer">SchemaBuffer(<code>key</code>, <code>cast</code>)</a></h3><p>Buffer SchemaType constructor</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">SchemaBuffer</span> <span class="params">(key, options)</span> {</span>
>>>>>>> temp
...
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>$conditional</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span></span></li><li><code>[value]</code><span class="types"> &lt;<a href="#any">any</a>&gt; </span><span></span></li></ul></div><div class="description"></div><hr class="private"></div></li><li class="module private"><a href="https://github.com/LearnBoost/mongoose/tree/3.0.0rc0/schema/date.js" id="schema-date-js">schema/date.js</a><div class="item method private"><h3 id="schema_date_SchemaDate"><a href="#schema_date_SchemaDate">SchemaDate(<code>key</code>, <code>options</code>)</a></h3><p>Date SchemaType constructor.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">SchemaDate</span> <span class="params">(key, options)</span> {</span>
=======
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>$conditional</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span></span></li><li><code>[value]</code><span class="types"> &lt;<a href="#any">any</a>&gt; </span><span></span></li></ul></div><div class="description"></div><hr class="private"></div></li><li class="module private"><a href="https://github.com/LearnBoost/mongoose/tree/3.0.1/schema/date.js" id="schema-date-js">schema/date.js</a><div class="item method private"><h3 id="schema_date_SchemaDate"><a href="#schema_date_SchemaDate">SchemaDate(<code>key</code>, <code>options</code>)</a></h3><p>Date SchemaType constructor.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">SchemaDate</span> <span class="params">(key, options)</span> {</span>
>>>>>>> temp
  SchemaType.call(<span class="keyword">this</span>, key, options);
  ...
  <span class="keyword">return</span> handler.call(<span class="keyword">this</span>, val);
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>$conditional</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span></span></li><li><code>[value]</code><span class="types"> &lt;<a href="#any">any</a>&gt; </span><span></span></li></ul></div><div class="description"></div><hr class="private"></div></li><li class="module private"><a href="https://github.com/LearnBoost/mongoose/tree/3.0.0rc0/schema/documentarray.js" id="schema-documentarray-js">schema/documentarray.js</a><div class="item method private"><h3 id="schema_documentarray_DocumentArray"><a href="#schema_documentarray_DocumentArray">DocumentArray(<code>key</code>, <code>schema</code>, <code>options</code>)</a></h3><p>SubdocsArray SchemaType constructor</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">DocumentArray</span> <span class="params">(key, schema, options)</span> {</span>
=======
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>$conditional</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span></span></li><li><code>[value]</code><span class="types"> &lt;<a href="#any">any</a>&gt; </span><span></span></li></ul></div><div class="description"></div><hr class="private"></div></li><li class="module private"><a href="https://github.com/LearnBoost/mongoose/tree/3.0.1/schema/documentarray.js" id="schema-documentarray-js">schema/documentarray.js</a><div class="item method private"><h3 id="schema_documentarray_DocumentArray"><a href="#schema_documentarray_DocumentArray">DocumentArray(<code>key</code>, <code>schema</code>, <code>options</code>)</a></h3><p>SubdocsArray SchemaType constructor</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">DocumentArray</span> <span class="params">(key, schema, options)</span> {</span>
>>>>>>> temp
...
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>value</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span></span></li><li><code>document</code><span class="types"> &lt;<a href="#document_Document">Document</a>&gt; </span><span>that triggers the casting</span></li></ul></div><div class="description"></div><hr class="private"></div></li><li class="module private"><a href="https://github.com/LearnBoost/mongoose/tree/3.0.0rc0/schema/mixed.js" id="schema-mixed-js">schema/mixed.js</a><div class="item method private"><h3 id="schema_mixed_Mixed"><a href="#schema_mixed_Mixed">Mixed(<code>path</code>, <code>options</code>)</a></h3><p>Mixed SchemaType constructor.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">Mixed</span> <span class="params">(path, options)</span> {</span>
=======
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>value</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span></span></li><li><code>document</code><span class="types"> &lt;<a href="#document_Document">Document</a>&gt; </span><span>that triggers the casting</span></li></ul></div><div class="description"></div><hr class="private"></div></li><li class="module private"><a href="https://github.com/LearnBoost/mongoose/tree/3.0.1/schema/mixed.js" id="schema-mixed-js">schema/mixed.js</a><div class="item method private"><h3 id="schema_mixed_Mixed"><a href="#schema_mixed_Mixed">Mixed(<code>path</code>, <code>options</code>)</a></h3><p>Mixed SchemaType constructor.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">Mixed</span> <span class="params">(path, options)</span> {</span>
>>>>>>> temp
...
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>$cond</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span></span></li><li><code>[val]</code><span class="types"> &lt;<a href="#any">any</a>&gt; </span><span></span></li></ul></div><div class="description"></div><hr class="private"></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.0rc0/schema/number.js" id="schema-number-js">schema/number.js</a><div class="item method private"><h3 id="schema_number_SchemaNumber"><a href="#schema_number_SchemaNumber">SchemaNumber(<code>key</code>, <code>options</code>)</a></h3><p>Number SchemaType constructor.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">SchemaNumber</span> <span class="params">(key, options)</span> {</span>
=======
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>$cond</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span></span></li><li><code>[val]</code><span class="types"> &lt;<a href="#any">any</a>&gt; </span><span></span></li></ul></div><div class="description"></div><hr class="private"></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.1/schema/number.js" id="schema-number-js">schema/number.js</a><div class="item method private"><h3 id="schema_number_SchemaNumber"><a href="#schema_number_SchemaNumber">SchemaNumber(<code>key</code>, <code>options</code>)</a></h3><p>Number SchemaType constructor.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">SchemaNumber</span> <span class="params">(key, options)</span> {</span>
>>>>>>> temp
...
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>$conditional</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span></span></li><li><code>[value]</code><span class="types"> &lt;<a href="#any">any</a>&gt; </span><span></span></li></ul></div><div class="description"></div><hr class="private"></div></li><li class="module private"><a href="https://github.com/LearnBoost/mongoose/tree/3.0.0rc0/schema/objectid.js" id="schema-objectid-js">schema/objectid.js</a><div class="item method private"><h3 id="schema_objectid_ObjectId"><a href="#schema_objectid_ObjectId">ObjectId(<code>key</code>, <code>options</code>)</a></h3><p>ObjectId SchemaType constructor.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">ObjectId</span> <span class="params">(key, options)</span> {</span>
=======
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>$conditional</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span></span></li><li><code>[value]</code><span class="types"> &lt;<a href="#any">any</a>&gt; </span><span></span></li></ul></div><div class="description"></div><hr class="private"></div></li><li class="module private"><a href="https://github.com/LearnBoost/mongoose/tree/3.0.1/schema/objectid.js" id="schema-objectid-js">schema/objectid.js</a><div class="item method private"><h3 id="schema_objectid_ObjectId"><a href="#schema_objectid_ObjectId">ObjectId(<code>key</code>, <code>options</code>)</a></h3><p>ObjectId SchemaType constructor.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">ObjectId</span> <span class="params">(key, options)</span> {</span>
>>>>>>> temp
...
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>turnOn</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Boolean">Boolean</a>&gt; </span><span>auto generated ObjectId defaults</span></li></ul></div><div class="description"></div><hr class="private"></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.0rc0/schema/string.js" id="schema-string-js">schema/string.js</a><div class="item method private"><h3 id="schema_string_SchemaString"><a href="#schema_string_SchemaString">SchemaString(<code>key</code>, <code>options</code>)</a></h3><p>String SchemaType constructor.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">SchemaString</span> <span class="params">(key, options)</span> {</span>
=======
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>turnOn</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Boolean">Boolean</a>&gt; </span><span>auto generated ObjectId defaults</span></li></ul></div><div class="description"></div><hr class="private"></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.1/schema/string.js" id="schema-string-js">schema/string.js</a><div class="item method private"><h3 id="schema_string_SchemaString"><a href="#schema_string_SchemaString">SchemaString(<code>key</code>, <code>options</code>)</a></h3><p>String SchemaType constructor.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">SchemaString</span> <span class="params">(key, options)</span> {</span>
>>>>>>> temp
...
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>$conditional</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span></span></li><li><code>[val]</code><span class="types"> &lt;<a href="#any">any</a>&gt; </span><span></span></li></ul></div><div class="description"></div><hr class="private"></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.0rc0/schema.js" id="schema-js">schema.js</a><div class="item method public"><h3 id="schema_Schema"><a href="#schema_Schema">Schema(<code>definition</code>)</a></h3><p>Schema constructor.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">Schema</span> <span class="params">(obj, options)</span> {</span>
=======
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>$conditional</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span></span></li><li><code>[val]</code><span class="types"> &lt;<a href="#any">any</a>&gt; </span><span></span></li></ul></div><div class="description"></div><hr class="private"></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.1/schema.js" id="schema-js">schema.js</a><div class="item method public"><h3 id="schema_Schema"><a href="#schema_Schema">Schema(<code>definition</code>)</a></h3><p>Schema constructor.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">Schema</span> <span class="params">(obj, options)</span> {</span>
>>>>>>> temp
...
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>method</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span></span></li><li><code>callback</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="see"><h4>See:</h4><ul class="see"><li><a href="https://github.com/bnoguchi/hooks-js/tree/31ec571cef0332e21121ee7157e0cf9728572cc3" title="hooks.js">hooks.js</a></li></ul></div><div class="description"><h4>Example</h4>
=======
...
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>method</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span>name of the method to hook</span></li><li><code>fn</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span>callback</span></li></ul></div><div class="see"><h4>See:</h4><ul class="see"><li><a href="https://github.com/bnoguchi/hooks-js/tree/31ec571cef0332e21121ee7157e0cf9728572cc3" title="hooks.js">hooks.js</a></li></ul></div><div class="description"><p>Post hooks fire <code>on</code> the event emitted from document instances of Models compiled from this schema.</p>
=======
...
>>>>>>> temp
  ...
  <span class="keyword">return</span> <span class="keyword">this</span>;
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>method</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>, <a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span>name</span></li><li><code>[fn]</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="description"><h4>Example</h4>
=======
...
fizz.scratch();</code></pre></div><hr class=""></div><div class="item method public"><h3 id="schema_Schema-static"><a href="#schema_Schema-static">Schema#static(<code>name</code>, <code>fn</code>)</a></h3><p>Adds static "class" methods to Models compiled from this schema.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">Schema.prototype.static = <span class="keyword">function</span>(name, fn) {
  ...
  <span class="keyword">return</span> <span class="keyword">this</span>;
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>name</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span></span></li><li><code>fn</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="description"><h4>Example</h4>
=======
...
<<<<<<< HEAD
}</code></pre><hr class="private"></div></li><li class="module private"><a href="https://github.com/LearnBoost/mongoose/tree/3.0.0rc0/schemadefault.js" id="schemadefault-js">schemadefault.js</a><div class="item property private"><h3 id="schemadefault_exports-system-profile"><a href="#schemadefault_exports-system-profile">exports#<span>system.profile</span></a></h3><p>Default model for querying the system.profiles collection.</p><hr class="private"></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.0rc0/schematype.js" id="schematype-js">schematype.js</a><div class="item method public"><h3 id="schematype_SchemaType"><a href="#schematype_SchemaType">SchemaType(<code>path</code>, <code>[options]</code>, <code>[instance]</code>)</a></h3><p>SchemaType constructor</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">SchemaType</span> <span class="params">(path, options, instance)</span> {</span>
=======
}</code></pre><hr class="private"></div></li><li class="module private"><a href="https://github.com/LearnBoost/mongoose/tree/3.0.1/schemadefault.js" id="schemadefault-js">schemadefault.js</a><div class="item property private"><h3 id="schemadefault_exports-system-profile"><a href="#schemadefault_exports-system-profile">exports#<span>system.profile</span></a></h3><p>Default model for querying the system.profiles collection.</p><hr class="private"></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.1/schematype.js" id="schematype-js">schematype.js</a><div class="item method public"><h3 id="schematype_SchemaType"><a href="#schematype_SchemaType">SchemaType(<code>path</code>, <code>[options]</code>, <code>[instance]</code>)</a></h3><p>SchemaType constructor</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">SchemaType</span> <span class="params">(path, options, instance)</span> {</span>
>>>>>>> temp
  <span class="keyword">this</span>.path = path;
...
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>val</code><span class="types"> &lt;<a href="#any">any</a>&gt; </span><span>default value</span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#schematype_SchemaType">SchemaType</a>, <a href="#defaultValue">defaultValue</a>&gt; </span><span></span></li></ul></div><div class="description"><h4>Example:</h4>

<pre><code><span class="keyword">var</span> s = <span class="keyword">new</span> Schema({ n: { type: Number, <span class="keyword">default</span>: <span class="number">10</span> })
<span class="keyword">var</span> M = db.model(<span class="string">'M'</span>, s)
<span class="keyword">var</span> m = <span class="keyword">new</span> M;
console.log(m.n) <span class="comment">// 10</span></code></pre></div><hr class=""></div><div class="item method public"><h3 id="schematype_SchemaType-index"><a href="#schematype_SchemaType-index">SchemaType#index(<code>options</code>)</a></h3><p>Declares the index options for this schematype.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">SchemaType.prototype.index = <span class="function"><span class="keyword">function</span> <span class="params">(options)</span> {</span>
...
schema.expires(<span class="string">'7d'</span>);</code></pre></div><hr class=""></div><div class="item method public"><h3 id="schematype_SchemaType-set"><a href="#schematype_SchemaType-set">SchemaType#set(<code>fn</code>)</a></h3><p>Adds a setter to this schematype.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">SchemaType.prototype.set = <span class="function"><span class="keyword">function</span> <span class="params">(fn)</span> {</span>
  ...
  <span class="keyword">return</span> <span class="keyword">this</span>;
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>fn</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#schematype_SchemaType">SchemaType</a>&gt; </span><span>this</span></li></ul></div><div class="description"><h4>Example:</h4>
=======
...
<<<<<<< HEAD
  ...
  <span class="keyword">return</span> <span class="keyword">this</span>;
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>obj</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span>validator</span></li><li><code>[error]</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span>optional error message</span></li></ul></div><div class="description"><p>Validators must return <code>Boolean</code>. Returning false is interpreted as validation failure.</p>
=======
...
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>value</code><span class="types"> &lt;<a href="#any">any</a>&gt; </span><span></span></li><li><code>callback</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li><li><code>scope</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span></span></li></ul></div><div class="description"></div><hr class="private"></div><div class="item static private"><h3 id="schematype_SchemaType-_isRef"><a href="#schematype_SchemaType-_isRef">SchemaType._isRef(<code>self</code>, <code>value</code>, <code>init</code>)</a></h3><p>Determines if value is a valid Reference.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">SchemaType._isRef = <span class="function"><span class="keyword">function</span> <span class="params">(self, value, init)</span> {</span>
=======
...
<<<<<<< HEAD
}</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>self</code><span class="types"> &lt;<a href="#schematype_SchemaType">SchemaType</a>&gt; </span><span></span></li><li><code>value</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span></span></li><li><code>init</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Boolean">Boolean</a>&gt; </span><span></span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Boolean">Boolean</a>&gt; </span><span></span></li></ul></div><hr class="private"></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.0rc0/types/array.js" id="types-array-js">types/array.js</a><div class="item method private"><h3 id="types_array_MongooseArray"><a href="#types_array_MongooseArray">MongooseArray(<code>values</code>, <code>path</code>, <code>doc</code>)</a></h3><p>Mongoose Array constructor.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">MongooseArray</span> <span class="params">(values, path, doc)</span> {</span>
=======
}</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>self</code><span class="types"> &lt;<a href="#schematype_SchemaType">SchemaType</a>&gt; </span><span></span></li><li><code>value</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span></span></li><li><code>init</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Boolean">Boolean</a>&gt; </span><span></span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Boolean">Boolean</a>&gt; </span><span></span></li></ul></div><hr class="private"></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.1/types/array.js" id="types-array-js">types/array.js</a><div class="item method private"><h3 id="types_array_MongooseArray"><a href="#types_array_MongooseArray">MongooseArray(<code>values</code>, <code>path</code>, <code>doc</code>)</a></h3><p>Mongoose Array constructor.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">MongooseArray</span> <span class="params">(values, path, doc)</span> {</span>
>>>>>>> temp
  <span class="keyword">var</span> arr = [];
...
<<<<<<< HEAD
</ul></div><hr class=""></div><div class="item property private"><h3 id="types_buffer_MongooseBuffer-_parent"><a href="#types_buffer_MongooseBuffer-_parent">MongooseBuffer#<span>_parent</span></a></h3><p>Parent owner document</p><hr class="private"></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.0rc0/types/documentarray.js" id="types-documentarray-js">types/documentarray.js</a><div class="item method private"><h3 id="types_documentarray_MongooseDocumentArray"><a href="#types_documentarray_MongooseDocumentArray">MongooseDocumentArray(<code>values</code>, <code>path</code>, <code>doc</code>)</a></h3><p>DocumentArray constructor</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">MongooseDocumentArray</span> <span class="params">(values, path, doc)</span> {</span>
=======
</ul></div><hr class=""></div><div class="item property private"><h3 id="types_buffer_MongooseBuffer-_parent"><a href="#types_buffer_MongooseBuffer-_parent">MongooseBuffer#<span>_parent</span></a></h3><p>Parent owner document</p><hr class="private"></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.1/types/documentarray.js" id="types-documentarray-js">types/documentarray.js</a><div class="item method private"><h3 id="types_documentarray_MongooseDocumentArray"><a href="#types_documentarray_MongooseDocumentArray">MongooseDocumentArray(<code>values</code>, <code>path</code>, <code>doc</code>)</a></h3><p>DocumentArray constructor</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">MongooseDocumentArray</span> <span class="params">(values, path, doc)</span> {</span>
>>>>>>> temp
  <span class="keyword">var</span> arr = [];
...
<<<<<<< HEAD
}</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>event</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span></span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="description"></div><hr class="private"></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.0rc0/types/embedded.js" id="types-embedded-js">types/embedded.js</a><div class="item method private"><h3 id="types_embedded_EmbeddedDocument"><a href="#types_embedded_EmbeddedDocument">EmbeddedDocument(<code>obj</code>, <code>parentArr</code>, <code>skipId</code>)</a></h3><p>EmbeddedDocument constructor.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">EmbeddedDocument</span> <span class="params">(obj, parentArr, skipId)</span> {</span>
=======
}</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>event</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span></span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Function">Function</a>&gt; </span><span></span></li></ul></div><div class="description"></div><hr class="private"></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.1/types/embedded.js" id="types-embedded-js">types/embedded.js</a><div class="item method private"><h3 id="types_embedded_EmbeddedDocument"><a href="#types_embedded_EmbeddedDocument">EmbeddedDocument(<code>obj</code>, <code>parentArr</code>, <code>skipId</code>)</a></h3><p>EmbeddedDocument constructor.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">EmbeddedDocument</span> <span class="params">(obj, parentArr, skipId)</span> {</span>
>>>>>>> temp
...
doc.markModified(<span class="string">'mixed.type'</span>);</code></pre></div><hr class=""></div><div class="item method private"><h3 id="types_embedded_EmbeddedDocument-save"><a href="#types_embedded_EmbeddedDocument-save">EmbeddedDocument#save(<code>[fn]</code>)</a></h3><p>Used as a stub for <a href="https://github.com/bnoguchi/hooks-js/tree/31ec571cef0332e21121ee7157e0cf9728572cc3">hooks.js</a></p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">EmbeddedDocument.prototype.save = <span class="keyword">function</span>(fn) {
  ...
  <span class="keyword">return</span> <span class="keyword">this</span>;
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>[fn]</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#types_embedded_EmbeddedDocument">EmbeddedDocument</a>&gt; </span><span>this</span></li></ul></div><div class="description"><h4>NOTE:</h4>
=======
...
<p><em>This is a no-op. Does not actually save the doc to the db.</em></p></div><hr class="private"></div><div class="item method public"><h3 id="types_embedded_EmbeddedDocument-remove"><a href="#types_embedded_EmbeddedDocument-remove">EmbeddedDocument#remove(<code>[fn]</code>)</a></h3><p>Removes the subdocument from its parent array.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">EmbeddedDocument.prototype.remove = <span class="function"><span class="keyword">function</span> <span class="params">(fn)</span> {</span>
  ...
  <span class="keyword">return</span> <span class="keyword">this</span>;
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>[fn]</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="description"></div><hr class=""></div><div class="item method private"><h3 id="types_embedded_EmbeddedDocument-update"><a href="#types_embedded_EmbeddedDocument-update">EmbeddedDocument#update()</a></h3><p>Override #update method of parent documents.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">EmbeddedDocument.prototype.update = <span class="function"><span class="keyword">function</span> <span class="params">()</span> {</span>
=======
...
<<<<<<< HEAD
  <span class="keyword">return</span> <span class="keyword">this</span>.__parentArrary;
}</code></pre></div><div class="description"></div><hr class=""></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.0rc0/types/objectid.js" id="types-objectid-js">types/objectid.js</a><div class="item method public"><h3 id="types_objectid_ObjectId"><a href="#types_objectid_ObjectId">ObjectId()</a></h3><p>ObjectId type constructor</p><div class="description"><h4>Example</h4>

<pre><code><span class="keyword">var</span> id = <span class="keyword">new</span> mongoose.Types.ObjectId;</code></pre></div><hr class=""></div><div class="item static private"><h3 id="types_objectid_ObjectId-fromString"><a href="#types_objectid_ObjectId-fromString">ObjectId.fromString(<code>str</code>)</a></h3><p>Creates an ObjectId from <code>str</code></p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">ObjectId.fromString;</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>str</code><span class="types"> &lt;<a href="#types_objectid_ObjectId">ObjectId</a>, <a href="#HexString">HexString</a>&gt; </span><span></span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#types_objectid_ObjectId">ObjectId</a>&gt; </span><span></span></li></ul></div><hr class="private"></div><div class="item static private"><h3 id="types_objectid_ObjectId-toString"><a href="#types_objectid_ObjectId-toString">ObjectId.toString(<code>oid</code>)</a></h3><p>Converts <code>oid</code> to a string.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">ObjectId.toString;</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>oid</code><span class="types"> &lt;<a href="#types_objectid_ObjectId">ObjectId</a>&gt; </span><span>ObjectId instance</span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span></span></li></ul></div><hr class="private"></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.0rc0/utils.js" id="utils-js">utils.js</a><div class="item static private"><h3 id="utils_exports-toCollectionName"><a href="#utils_exports-toCollectionName">exports.toCollectionName(<code>name</code>)</a></h3><p>Produces a collection name from model <code>name</code>.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">exports.toCollectionName = <span class="function"><span class="keyword">function</span> <span class="params">(name)</span> {</span>
=======
  <span class="keyword">return</span> <span class="keyword">this</span>.__parentArray;
}</code></pre></div><div class="description"></div><hr class=""></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.1/types/objectid.js" id="types-objectid-js">types/objectid.js</a><div class="item method public"><h3 id="types_objectid_ObjectId"><a href="#types_objectid_ObjectId">ObjectId()</a></h3><p>ObjectId type constructor</p><div class="description"><h4>Example</h4>

<pre><code><span class="keyword">var</span> id = <span class="keyword">new</span> mongoose.Types.ObjectId;</code></pre></div><hr class=""></div><div class="item static private"><h3 id="types_objectid_ObjectId-fromString"><a href="#types_objectid_ObjectId-fromString">ObjectId.fromString(<code>str</code>)</a></h3><p>Creates an ObjectId from <code>str</code></p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">ObjectId.fromString;</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>str</code><span class="types"> &lt;<a href="#types_objectid_ObjectId">ObjectId</a>, <a href="#HexString">HexString</a>&gt; </span><span></span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#types_objectid_ObjectId">ObjectId</a>&gt; </span><span></span></li></ul></div><hr class="private"></div><div class="item static private"><h3 id="types_objectid_ObjectId-toString"><a href="#types_objectid_ObjectId-toString">ObjectId.toString(<code>oid</code>)</a></h3><p>Converts <code>oid</code> to a string.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">ObjectId.toString;</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>oid</code><span class="types"> &lt;<a href="#types_objectid_ObjectId">ObjectId</a>&gt; </span><span>ObjectId instance</span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String">String</a>&gt; </span><span></span></li></ul></div><hr class="private"></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.1/utils.js" id="utils-js">utils.js</a><div class="item static private"><h3 id="utils_exports-toCollectionName"><a href="#utils_exports-toCollectionName">exports.toCollectionName(<code>name</code>)</a></h3><p>Produces a collection name from model <code>name</code>.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">exports.toCollectionName = <span class="function"><span class="keyword">function</span> <span class="params">(name)</span> {</span>
>>>>>>> temp
...
<<<<<<< HEAD
}</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>object</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span></span></li></ul></div><hr class="private"></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.0rc0/virtualtype.js" id="virtualtype-js">virtualtype.js</a><div class="item method public"><h3 id="virtualtype_VirtualType"><a href="#virtualtype_VirtualType">VirtualType()</a></h3><p>VirtualType constructor</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">VirtualType</span> <span class="params">(options)</span> {</span>
=======
}</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>object</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Object">Object</a>&gt; </span><span></span></li></ul></div><hr class="private"></div></li><li class="module "><a href="https://github.com/LearnBoost/mongoose/tree/3.0.1/virtualtype.js" id="virtualtype-js">virtualtype.js</a><div class="item method public"><h3 id="virtualtype_VirtualType"><a href="#virtualtype_VirtualType">VirtualType()</a></h3><p>VirtualType constructor</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript"><span class="function"><span class="keyword">function</span> <span class="title">VirtualType</span> <span class="params">(options)</span> {</span>
>>>>>>> temp
  <span class="keyword">this</span>.getters = [];
  <span class="keyword">this</span>.setters = [];
  <span class="keyword">this</span>.options = options || {};
...
fullname <span class="keyword">instanceof</span> mongoose.VirtualType <span class="comment">// true</span></code></pre></div><hr class=""></div><div class="item method public"><h3 id="virtualtype_VirtualType-get"><a href="#virtualtype_VirtualType-get">VirtualType#get(<code>fn</code>)</a></h3><p>Defines a getter.</p><span class="showcode">show code</span><div class="sourcecode"><pre><code class="javascript">VirtualType.prototype.get = <span class="function"><span class="keyword">function</span> <span class="params">(fn)</span> {</span>
  ...
  <span class="keyword">return</span> <span class="keyword">this</span>;
<<<<<<< HEAD
};</code></pre></div><div class="params"><h4>Parameters:</h4><ul><li><code>fn</code><span class="types"> &lt;<a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date">Function</a>&gt; </span><span></span></li></ul></div><div class="returns"><h4>Returns:</h4><ul><li><span class="types"> &lt;<a href="#virtualtype_VirtualType">VirtualType</a>&gt; </span><span>this</span></li></ul></div><div class="description"><h4>Example:</h4>
=======
